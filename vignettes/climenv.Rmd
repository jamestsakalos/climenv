...
WorldClim are available at a spatial resolution of 30 arc-seconds (~1 km2). The 
...
```{r holdridge-diagram, fig.height = 5, fig.width = 5, fig.align = "center", fig.cap="Fig 1. Placeholder for Holdridge’s (1967) life zone classification"}
# Make Holdridge’s (1967) life zone classification diagram
plot_h(data = data_py, "0")
```
```{r walter-leigh-diagram, fig.height = 5, fig.width = 5, fig.align = "center", fig.cap="Fig 2. Walter-Leigh’s (1960) climate diagram"}
# Make Walter-Leigh's (1960) climate diagram
plot_wl(data = data_py, "0")
```
```{r custom-climate-diagram, fig.height = 4, fig.width = 7, fig.align = "center", fig.cap="Fig 3. Custom climate diagram."}
