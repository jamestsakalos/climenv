...
for(i in 1:length(temp2)){
  values(r)<-x[i]
  writeRaster(r, paste0(temp_path, "/clim/tmax/",temp2[i]))
}
...
for(i in 1:length(temp2)){
  values(r)<-x[i]
  writeRaster(r, paste0(temp_path, "/clim/tmin/",temp2[i]))
}
...
for(i in 1:length(temp2)){
  values(r)<-x[i]
  writeRaster(r, paste0(temp_path, "/clim/tmean/",temp2[i]))
}
...
data_py<-ce_extract(file.path(temp_path, "clim"),
                    file.path(temp_path, "elev"),
                    location = pol_py, location_g = NULL,
                    c_source = "WorldClim")

data_pt<-ce_extract(file.path(temp_path, "clim"),
                    file.path(temp_path, "elev"),
