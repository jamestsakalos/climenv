##' Sibillini Biome extracted data
##'
##' The package contains extracted climatic and elevation data capturing Italy's
...
##' @references{ Mucina, L., Div&scaronek, J., Tsakalos, J.L. (2022).
